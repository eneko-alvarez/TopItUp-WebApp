...
Una app para contar **literalmente lo que te dé la gana**. Cervezas, cafés, flexiones, veces que ella te dice "es que no te veo así"... tú decides.

### ✨ Lo que hace

- 📊 **Crea grupos** (ej: Bebidas) con varios contadores dentro
- 🎯 **Contadores individuales** para cosas random
- ➕ **Incrementa con un toque** - nada de complicaciones
...
- MySQL (la base de datos de toda la vida)
- Vanilla JS (nada de React, siguiente pregunta)
